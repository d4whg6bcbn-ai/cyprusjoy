...
export function ButtonLink({
  ...
  const styles = {
    primary:
      "inline-flex items-center justify-center rounded-md bg-[#496236] px-6 py-3.5 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#3b502b] hover:shadow-lg",
    secondary:
